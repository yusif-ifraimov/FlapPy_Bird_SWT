...
class Bird(Thread):__tag = "Bird"
    ...
    def birdIsAlive(self):return self.__isAlive

    def checkCollision(self):position = list(self.__canvas.bbox(self.__tag))
    ...
    def jumps(self, event=None):self.checkCollision()
    ...
    def kill(self):self.__isAlive = False

    def run(self):self.__running = True
