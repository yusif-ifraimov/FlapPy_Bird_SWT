...
print('A python version of famous Flapy Bird Game')
print('Here is your manual:')
print('start - to start the game')
print('mode - to set up mode')
print('y - yes n - no')
...
while True:
    ...
    if command == 'mode':
        while True:
            ...
            if command == 'mode':
                mode_set = input('Do you want to change to furry mode? y/n')
                if mode_set == 'y' or mode_set == 'Y':
                    print('You have switched to furry mode!')
                    FURYMODE = True
                    break
                elif mode_set == 'n' or mode_set == 'N':
                    print('You wil play in classic mode')
                    FURYMODE = False
                    break
                else:
                    print('Wrong command!')
...
while True:
    if command == 'start':
        print('Controls: space/up_key - jump')
        print('To exit from the game press esc')
        print('To switch to furry mode during the game press 1 on the welcome screen')
...
# True if the user plays the fury modeR
# In fury mode, the pipe spawn system is different than in
